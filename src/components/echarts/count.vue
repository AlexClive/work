<template>
  <div id="count">
    <div id="main" style="min-width: 600px;min-height:800px;"></div>
  </div>
</template>
...
// 绘制图表
                ...
                for (const item of this.result.feature_importance) {
                ...
                for (const item of this.result.actualvsfitted) {
                ...
                if (this.result.indicator) {
                    for (const iterator of this.result.indicator) {
                        indicator.push({
